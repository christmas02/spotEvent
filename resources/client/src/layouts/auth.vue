            ...
            <div class="welcome">
                ...
                <div class="d-flex flex-column align-items-center w-100">
                    ...
                    <div class="btn-container">
                        <v-btn color="primary" :to="{name: 'auth-register'}" x-large :outlined="action === 'register'">S'inscrire</v-btn>
                        <v-btn color="primary" :to="{name: 'auth-login'}" x-large :outlined="action === 'login'">Se connecter</v-btn>
                    </div>
                </div>
            </div>
