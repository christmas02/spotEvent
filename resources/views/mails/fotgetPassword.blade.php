                                                    ...
                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" valign="middle"
                                                                                ...
                                                                                <a href="#"
                                                                                    ...
                                                                                    aria-hidden="true">
                                                                                    <img src="{{asset('/img/header-email.png')}}"
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top"
                                                                ...
                                                                <ul style="direction:ltr;margin-top:0;margin-bottom:0;padding:0;font-family:Roboto,Arial,Helvetica,sans-serif;color:#131313;font-size:16px;line-height:24px;margin-left:24px"
                                                                    type="disc">
