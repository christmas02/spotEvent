                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li style="color: #fff;" ><a href="/fiche_actif/{{ $infoUser->id }}" class="btn btn-info">Fiches actif</a></li>
                            <li ><a href="/fiche_non_actif/{{ $infoUser->id }}" class="btn btn-danger">Fiches non actifs</a></li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
