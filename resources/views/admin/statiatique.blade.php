                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card">
                                            <div class="body l-parpl text-center">
                                                ...
                                                <h3 class="m-b-0 m-t-10 text-white number count-to" data-from="0" data-to="2078" data-speed="2000" data-fresh-interval="700">0</h3>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card">
                                            <div class="body l-seagreen text-center">
                                                ...
                                                <h3 class="m-b-0 m-t-10 text-white number count-to" data-from="0" data-to="1278" data-speed="2000" data-fresh-interval="700">0</h3>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card">
                                            <div class="body l-amber text-center">
                                                ...
                                                <h3 class="m-b-0 m-t-10 text-white number count-to" data-from="0" data-to="521" data-speed="2000" data-fresh-interval="700">0</h3>
