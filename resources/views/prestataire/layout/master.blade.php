                  ...
                  $.each(data, function(index, subcatObj){
                    $('.msg_history').append(function(){
                      ...
                      if(id == id_user){
                        ...
                        return '<div class="incoming_msg"><div class="received_msg"><div class="received_withd_msg">'+"Lui :"+'<p>'+subcatObj.contenus+'</p><span class="time_date">'+subcatObj.created_at+'</span>'+'</div></div>';
                      }
