				  ...
				  @endif
                    ...
                    <div class="col-md-7 col-sm-7 ">
                      <div class="product-image">
                        <img src="{{asset('/image/'.$appartement->image_one)}}" alt="..." />
                      </div>
                      <div class="product_gallery">
                        <a>
                          <img src="{{asset('/image/'.$appartement->image_two)}}" alt="..." />
                        </a>
                        <a>
                          <img src="{{asset('/image/'.$appartement->image_three)}}" alt="..." />
                        </a>
                        <a>
                          <img src="{{asset('/image/'.$appartement->image_for)}}" alt="..." />
                        </a>
                        <a>
                          <img src="{{asset('/image/'.$appartement->image_five)}}" alt="..." />
                        </a>
                      </div>
                    </div>
                    ...
                    @if($appartement->statu == 0 )
                       <a href="/activ/appartement/{{ $appartement->id }}" class="btn btn-danger "><i class="fa fa-"></i> Activer le post</a>
                    @elseif($appartement->statu == 1 )
                       <a href="/desact/appartement/{{ $appartement->id }}" class="btn btn-success   "><i class="fa fa-"></i> Desactiver le post</a>
                    ...
                    @endif
                      ...
                      <div class="">
                        ...
                        <ul class="list-inline prod_size display-layout">
                          <li>
                            <button type="button" class="btn btn-default btn-xs">Nbre de Piece : {{ $appartement->nbre_pierce }}</button>
                          </li>
                          <li>
                            <button type="button" class="btn btn-default btn-xs">Nbre de lit : {{ $appartement->nbre_lit }}</button>
                          </li>
                          <li>
                            <button type="button" class="btn btn-default btn-xs">Nbre bouche : {{ $appartement->nbre_salle_eau }}</button>
                          </li>
...
<div class="modal fade" id="exampleModalCenterInfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                    <form method="POST" action="/update/poste/appart" enctype="multipart/form-data">
                        @csrf
                        <input type="text" hidden name="id" value="{{ $appartement->id }}">
                        <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" name="designation"
                                                class="form-control " value="{{ $appartement->titre }}">
                                        </div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <textarea rows="8" name="description" class="form-control" >{{ $appartement->description }}</textarea>
                                    </div>
                                </div>
