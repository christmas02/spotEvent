    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Ajouter un appartement <small></small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <div id="wizard" class="form_wizard wizard_horizontal">
							...
							<form method="POST" action="/save/appartement" enctype="multipart/form-data">
                            @csrf
                            <div id="step-1">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select required="required" name="nbre_pierce" class="form-control ">
                                                <option value="1"> 1 perce</option>
                                                <option value="2"> 2 perce</option>
