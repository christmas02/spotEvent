          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Immo <small>/ Liste des Appartements</small></h3>
              </div>
                      ...
                      @if($appartements)
                            @foreach($appartements as $items)
                                <tr>
                                    ...
                                    <td>{{ $items->nbre_lit }}</td>
                                    <td>{{ $items->nbre_salle_eau }}</td>
                                    <td>
                                    @if($items->statu == 1)
                                    ...
                                    <td>
                                        <div class="">
                                            <a href="/details/appartement/{{ $items->id }}" class="btn btn-primary btn-rounded"><i class="fa fa-folder"></i></a>
                                        </div> 
                                    </td>
                                </tr>
                            @endforeach
